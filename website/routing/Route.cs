...
namespace evefifo.website.routing
{
    public class Route
    {
        ...
        private readonly Func<Request, Task<Response>> m_Action;
        private readonly HttpMethod m_Method;

        public Route(string match, Func<Request, Task<Response>> action, HttpMethod method = null)
        {
        ...
        public Func<Request, Task<Response>> Action { get { return m_Action; } }
